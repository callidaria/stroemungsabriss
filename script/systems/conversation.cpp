	...
	: m_frame(frame),m_r2D(r2D),charManager(cm)
{
	...
	Toolbox::create_sprite_canvas_triangled(moodconv_verts,0,glm::vec2(0,50),100,400);
	Toolbox::create_sprite_canvas_triangled(moodconv_verts,1,glm::vec2(1100,0),180,720);
