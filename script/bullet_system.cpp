...
BulletSystem::BulletSystem(RendererI* rI)
	: m_rI(rI) {  }
void BulletSystem::add_cluster(uint16_t width,uint16_t height,uint32_t caps,const char* tPath)
{
...
{
	// TODO: check if pHitbox intersects with framestopped bullet clusters or delta shadowed hitboxes
	return false;
}
