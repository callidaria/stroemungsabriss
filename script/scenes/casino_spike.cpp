	...
	: m_ccbf(ccbf),m_setRigs(set_rigs)
{
	...
	// animation test
	m_ccbf->r3d->add("./res/testkaks.dae","./res/anim_tex.png");
	m_ccbf->r3d->mal[0].set_animation(0);
...
void CasinoSpike::render()
{
	...
	m_ccbf->r3d->mal[0].interpolate(&m_ccbf->r3d->as3d,m_ccbf->frame->get_time_delta());
